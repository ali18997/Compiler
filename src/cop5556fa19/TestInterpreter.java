...
//		static final boolean doPrint = false;
		...
		void whilebreak1() throws Exception {
			String input = "i = 10  "
					...
					+ "\nwhile i>0 "
					+ "\ndo if i < 4 "
					+ "\n   then do do do do break end end end end end"  //should break out of do, not just enclosing block
					+ "\ndummy=println(i) "
					+ "\nsum = sum + i   "
					+ "\ni=i-1 "
					+ "\n end "
		...
		void testOperators() throws Exception{
			String input = "a = 1+2^8 return a";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
			List<LuaValue> expected = makeExpectedWithInts(257);
			assertEquals(expected,ret);
		}
		@Test 
		void testRandom() throws Exception{
			String input = " while(true) do if(true) then if (true) then if(true) then break end end end end";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		...
		void testRandom1() throws Exception{
			String input = " x = 0 repeat x = x+1 until x > 3";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		...
		@Test 
		void testRandom3() throws Exception{
			String input = "a = 1&2 b = 3|4 c = 5^6 d = 3<<4 e = 5>>7 return a, b, c, d, e";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		...
		@Test 
		void testRandom4() throws Exception{
			String input = "a = print(1)";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		...
		void gotoTest() throws Exception{
			...
			List<LuaValue> ret = interpret(input);
			show(ret);
			List<LuaValue> expected = makeExpectedWithInts(1);
			assertEquals(expected,ret);
		}
		
		@Test
		void testOperatorsAgain() throws Exception{
			String input = "a = true return a";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		...
		@Test
		void testGrading1() throws Exception{
		...
		@Test
		void testGrading2() throws Exception{
		...
		@Test
		void testGrading3() throws Exception{
			String input = "return 1+2+3+4+5";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		...
		@Test
		void testGrading4() throws Exception{
			String input = "return 1+2*3+4*5";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		...
		@Test
		void testGrading5() throws Exception{
			String input = "return 1+2*(3+4)*5";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		...
		@Test
		void testGrading6() throws Exception{
			String input = "return 1<<2*3+4*5";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		...
		@Test
		void testGrading7() throws Exception{
		...
		@Test
		void testGrading8() throws Exception{
			String input = "return 1 ~ 2 | 3 & 4";
			show(input);
			List<LuaValue> ret = interpret(input);
			show(ret);
		...
		@Test
		void testGrading9() throws Exception{
		...
		@Test
		void testGrading10() throws Exception{
		...
		@Test
		void testGrading11() throws Exception{
		...
		@Test
		void testGrading12() throws Exception{
		...
		@Test
		void testGrading13() throws Exception{
		...
		@Test
		void testGrading14() throws Exception{
